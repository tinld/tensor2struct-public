...
from transformers import BertModel, ElectraModel, AutoModel, AutoTokenizer, AutoModelForMaskedLM, XLMRobertaConfig, XLMRobertaModel
...
class SpiderEncoderBert(torch.nn.Module):
    ...
    def __init__(
        ...
        self.base_enc_hidden_size = (
            1024 if "vinai/phobert-large" or "xlm-roberta-large" in bert_version else 768
        )
